...
This roadmap advanced the approved `v1.3` scope only: residual parser hardening, broader accepted-corpus MathJax normalization, and a reproducible parse/render proof workflow. Corpus-wide search, collaborator review, hosted deployment, and broader input modes remained deferred so the milestone could reduce real parser/render failures first. Before closeout, the shipped rendering path was also re-hardened to wait for MathJax `startup.promise` and to treat `assets/sre/` worker files as part of the exported dashboard contract.
...
- ✅ **v1.2 Dashboard, Export & Math Rendering Hardening** — Phases 10-13 shipped 2026-04-03
...
- ✅ **v1.3 Parse/Render Hardening** — Phases 14-16 shipped 2026-04-03
...
**Plans**: `14-01` completed on 2026-04-03
...
**Plans**: `15-01` completed on 2026-04-03
**UI hint**: yes
...
**Plans**: `16-01` completed on 2026-04-03
